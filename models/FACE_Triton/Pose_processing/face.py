...
class SCRFD:
    ...
    def forward(self, img, thresh):
        ...
        net_out = self.session
        net_outs=[]
        net_outs.append(np.reshape(net_out[0],(12800,1)))
        net_outs.append(np.reshape(net_out[2],(3200,1)))
        net_outs.append(np.reshape(net_out[4],(800,1)))
        net_outs.append(np.reshape(net_out[1],(12800,4)))
        net_outs.append(np.reshape(net_out[3],(3200,4)))
        net_outs.append(np.reshape(net_out[5],(800,4)))
